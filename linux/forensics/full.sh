...
#1.4 cpuinfo
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
echo -e "#command cat /proc/cpuinfo | grep 'model name'" >> "$(hostname -s).txt"
echo -e "\n" >> "$(hostname -s).txt"
cat /proc/cpuinfo | grep "model name" >> "$(hostname -s).txt"
...
#3.1 username associated with current effective user ID
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
echo -e "#command whoami" >> "$(hostname -s).txt"
echo -e "\n" >> "$(hostname -s).txt"
whoami >> "$(hostname -s).txt"

#3.2 users currently on the machine
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
...
#3.9 info about change password
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
...
#4.3
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
echo -e "#command ifconfig" >> "$(hostname -s).txt"
echo -e "\n" >> "$(hostname -s).txt"
ifconfig >> "$(hostname -s).txt"

#4.4
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
echo -e "#command iwconfig" >> "$(hostname -s).txt"
echo -e "\n" >> "$(hostname -s).txt"
iwconfig >> "$(hostname -s).txt"
...
#4.14 network and local sockets
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
echo -e "#command ss" >> "$(hostname -s).txt"
echo -e "\n" >> "$(hostname -s).txt"
ss >> "$(hostname -s).txt"

#4.15 all listen ports
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
echo -e "#command ss -l" >> "$(hostname -s).txt"
echo -e "\n" >> "$(hostname -s).txt"
ss -l >> "$(hostname -s).txt"

#4.16 only network ports
echo -e "\n\n\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" >> "$(hostname -s).txt"
